...
namespace JsonPayloadConverter.Helper
{
    public static class ConversionHelper
    {
        ...
        public static string ByteArrayCodedHextoString(byte[] data)
        {
            ...
            foreach (byte value in data)
            {
                ...
                /*if (value > 0x39)
                {
                    if (value > 0x60)
                    {
                        result.Append(value - 0x57);
                    }
                    else
                    {
                        //result.Append(value - 0x37);
                        result.Append((char)Convert.ToInt32(value));
                    }
                }
                else
                {
                    result.Append(value - 0x30);
                }*/
                result.Append((char)Convert.ToInt32(value));
            }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static string ByteArrayUnicodeHextoString(byte[] data)
        {
            StringBuilder result = new StringBuilder(data.Length);
        ...
        public static string ByteArrayUnicodetoString(byte[] data)
        {
            StringBuilder result = new StringBuilder(data.Length);
